...
//  StoryPrompt
//
//  Created by Lisa Vo on 11/30/21.
//
...
class StoryPromptTableViewController: UITableViewController {
	...
	override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
		if segue.identifier == "ShowStoryPrompt" {
			guard
				let storyPromptViewController = segue.destination as? StoryPromptViewController,
...
//				let storyPrompt = storyPromptViewController.storyPrompt
//		else { return }
