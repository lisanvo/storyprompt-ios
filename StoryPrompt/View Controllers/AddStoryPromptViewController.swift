...
//  StoryPrompt
//
//  Created by Lisa Vo on 10/25/21.
//
...
class AddStoryPromptViewController: UIViewController {
	...
	@IBAction func generateStoryPrompt(_ sender: Any) {
		...
		if storyPrompt.isValid() {
			...
			let alert = UIAlertController(title: "Invaid Story Prompt", message: "Please fill out all of the fields", preferredStyle: .alert)
...
extension AddStoryPromptViewController: UITextFieldDelegate {
	func textFieldShouldReturn(_ textField: UITextField) -> Bool {
		...
		// Use textfield default behavior
		return true
	}
}
